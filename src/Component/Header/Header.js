...
const Header = () => {
    return (
        <div>
            <div className="navbar bg-violet-200 text-indigo-900 lg:px-14 ">
  <div className="navbar-start">
      ...
      <label tabIndex={1} className="btn btn-ghost btn-circle">
                        ...
                        <a className="btn btn-ghost normal-case lg:text-3xl text-violet-700 font-serif">Knowledge Gather</a>
    </div>
  </div>
  <div className="navbar-start">
